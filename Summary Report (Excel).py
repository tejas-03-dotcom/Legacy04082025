...
async def generate_and_save_summary_report_excel():
    ...
    # Click on  Summary Report Excel option
    await page.click("#RepBldrTemplateImg3")  # Replace with actual selector
    print("✅ Clicked on Summary Report Excel option.")
    ...
    save_path = os.path.join(save_folder, "SummaryReportExcel.xlsx")
