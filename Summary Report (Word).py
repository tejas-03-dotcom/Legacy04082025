...
async def generate_and_save_summary_report_word():
    ...
    # Click on  Summary Report word option
    await page.click("#RepBldrTemplateImg1")
    print("✅ Clicked on Summary Report word option.")
...
asyncio.run(generate_and_save_summary_report_word())
