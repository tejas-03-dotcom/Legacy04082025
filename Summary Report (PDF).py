...
async def generate_and_save_summary_report_pdf():
    ...
    # Click on Summary Report pdf option
    await page.click("#RepBldrTemplateImg2")  # Replace with actual selector
    print("✅ Clicked on Summary Report pdf option.")
    ...
    save_path = os.path.join(save_folder, "SummaryReport.pdf")
...
asyncio.run(generate_and_save_summary_report_pdf())
