...
async def generate_as_excel_binder_options():
    async with async_playwright():
        ...
        save_path = await manage_download(
            page,
            button_selector="#layout_optionsButton_generateExcelLink_txt_0",  # Excel/PDF download button
            download_path=r"D:\Legacy04082025\downloads",
            file_name="fromoptionPDF.xls"
        )
...
if __name__ == "__main__":
    asyncio.run(generate_as_excel_binder_options())
