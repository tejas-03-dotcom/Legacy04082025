...
async def generate_and_save_ciqreport_landscape():
    ...
    # Click on CIQ Report LandScape option
    await page.click("#RepBldrTemplateImg8")  # Replace with actual selector
    print("✅ Clicked on ciq Report Landscape option.")
    ...
    save_path = os.path.join(save_folder, "CIQ ReportLandscape.docx")
...
asyncio.run(generate_and_save_ciqreport_landscape())
