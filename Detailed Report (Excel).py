...
async def generate_and_save_detailed_report_excel():
    ...
    # Click on Detailed Report Excel option
    await page.click("#RepBldrTemplateImg6")  # Replace with actual selector
    ...
    save_path = os.path.join(save_folder, "Detailed Report Excel.xlsx")
