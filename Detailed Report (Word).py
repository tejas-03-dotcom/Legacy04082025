...
async def generate_and_save_detailed_report_word():
    ...
    # Click on Detailed Report word option
    await page.click("#RepBldrTemplateImg5")  # Replace with actual selector
    print("✅ Clicked on Detailed Report word option.")
    ...
    save_path = os.path.join(save_folder, "DetailedReport.docx")
...
asyncio.run(generate_and_save_detailed_report_word())
