...
from downlodciqreport import download_report
...
async def generate_and_save_report():
    ...
    await page.click("#RepBldrTemplateImg22")  # Replace with actual selector
    print("✅ Clicked on Quick Report option.")
    await page.wait_for_timeout(5000)
    """
    ...
    save_path = os.path.join(save_folder, "QuickReport.pdf")
    await download.save_as(save_path)
   """
    save_folder = "D:/Legacy04082025/downloads"
    save_path = os.path.join(save_folder, "DetailedReport.pdf")
    await download_report(page, "body > div.wrapper >> text='Download'", save_path)
